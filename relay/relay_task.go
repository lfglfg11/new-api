...
func RelayTaskSubmit(c *gin.Context, info *relaycommon.RelayInfo) (*TaskSubmitResult, *dto.TaskError) {
	...
	if billing_setting.ShouldApplyTaskBillingRatios(modelName) {
	...
	if adjustedRatios := adaptor.AdjustBillingOnSubmit(info, taskData); billing_setting.ShouldApplyTaskBillingRatios(modelName) && len(adjustedRatios) > 0 {
